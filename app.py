...
.hero-h1 { font-family: 'Playfair Display', serif; font-size: clamp(2rem, 3.8vw, 3rem); font-weight: 600; color: var(--text-dark); line-height: 1.14; letter-spacing: -0.02em; margin-bottom: 1rem; }
...
<div class="ic"><div class="ic-dot" style="background:#1a6b3a;"></div><div class="ic-name">Ensemble</div><div class="ic-full">VGG16+GA x VGG16+PSO Fusion</div><div class="ic-bar"></div></div>
</div>
